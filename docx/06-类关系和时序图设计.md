...
classDiagram
    ...
    class AuthenticationService {
        ...
        +changePassword(String userId, String oldPassword, String newPassword) boolean
    }
    
    class EvaluationServiceInterface {
        <<interface>>
        +submitEvaluation(Evaluation evaluation) boolean
        +hasStudentEvaluated(String studentId, String teacherId, String courseId, String periodId) boolean
        +getEvaluationsByStudent(String studentId) List~Evaluation~
        +getEvaluationsByTeacher(String teacherId) List~Evaluation~
        +getActiveEvaluationPeriod() EvaluationPeriod
    }
    
    class DataRefreshCallback {
        <<interface>>
        +onDataRefresh() void
    }
    ...
    class StatisticsAnalyzer {
        <<interface>>
        +calculateAverage(List~Double~ scores) double
        +calculateStandardDeviation(List~Double~ scores) double
        +generateReport(Map~String,Object~ data) String
    }
    ...
    class Student {
        ...
        +getUserType() String
        +hasPermission(permission) boolean
        +getEvaluatableCourses(periodId) List~CourseOffering~
        +canEvaluateCourse(courseId, teacherId, periodId) boolean
    }
    ...
    class Teacher {
        ...
        +getUserType() String
        +hasPermission(permission) boolean
        +getTeachingCourses(semester) List~CourseOffering~
        +getEvaluationStatistics(periodId) Map~String,Object~
    }
    ...
    class AcademicAffairsStaff {
        ...
        +manageEvaluationCriteria(criteria, operation) boolean
    }
    ...
    class Administrator {
        ...
        +getUserType() String
        +hasPermission(permission) boolean
        +manageUser(user, operation) boolean
        +generateSystemReport(periodId) String
    }
    ...
    class Course {
        ...
        +getAverageScore(periodId) double
    }
    ...
    class CourseOffering {
        ...
        +isEvaluatable(periodId) boolean
    }
