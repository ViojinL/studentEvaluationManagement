...
```java
/**
 * 用户认证接口（注：实际项目中未使用独立接口，Service类直接实现功能）
 */
...
public abstract class User {
    ...
    protected LocalDateTime updatedAt; // 更新时间
    
    // 构造方法
    public User(String userId, String name, String gender, String password);
...
public class Student extends User {
     ...
     * @return 课程列表
     */
    public List<CourseOffering> getEvaluatableCourses(String periodId);
     ...
     * @return 可以评教返回true
     */
    public boolean canEvaluateCourse(String courseId, String teacherId, String periodId);
...
public class Teacher extends User {
     ...
     * @return 授课课程列表
     */
    public List<CourseOffering> getTeachingCourses(String semester);
     ...
     * @return 统计信息
     */
    public Map<String, Object> getEvaluationStatistics(String periodId);
